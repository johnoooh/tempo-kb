...
> 📖 **Authoritative source:** the official Tempo docs are the source of truth for running the pipeline — [docs site](https://cmotempo.netlify.app/) · [installation.md](https://github.com/mskcc/tempo/blob/develop/docs/installation.md) · [juno-setup.md](https://github.com/mskcc/tempo/blob/develop/docs/juno-setup.md) · [aws-setup.md](https://github.com/mskcc/tempo/blob/develop/docs/aws-setup.md). This KB page summarizes them and adds cross-links; if it ever disagrees with the official docs, trust the official docs (except where noted below).
>
